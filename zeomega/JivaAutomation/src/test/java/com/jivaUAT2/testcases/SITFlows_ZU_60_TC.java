...
public class SITFlows_ZU_60_TC extends TestBase {
	private static Logger logger = Logger.getLogger(SITFlows_ZU_60_TC.class);
	...
	public void verify_MemberData_fromfile_toScreen_ZU_60Integrationflow() throws InterruptedException {
		...
		Reporter.log("Started execution for integration flow of #ZU-60_CCM_Unable to reach member# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname+"<br>");
		...
		logger.info("Successfully completed validating integration flow of #ZU-60_CCM_Unable to reach member# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname);
		
		Reporter.log("Successfully completed validating integration flow of #ZU-60_CCM_Unable to reach member# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname);
