...
public class SITFlows_ZU_61_TC extends TestBase {
	private static Logger logger = Logger.getLogger(SITFlows_ZU_61_TC.class);
	...
	public void verify_MemberData_fromfile_toScreen_ZU_61Integrationflow() throws InterruptedException {
		...
		Reporter.log("Started execution for integration flow of #ZU-61_CCM_Member Opts out# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname+"<br>");
		...
		addInteractionsPage.add2ndInteractionforMemberOptsOut(sUSERPROFILENAME);
		addInteractionsPage.clickSaveInteraction();		
		addInteractionsPage.episodeOpenActivitiesAlert();				
		addInteractionsPage.sleep(5000);
		
		// ----- Verify Member Opts out letter generation -----	
		episodeactivitiespage.clickCM();
		episodeactivitiespage.sleep(10000);
		episodeoverviewpage.openCorrespondence();
		//Assert.assertEquals(true,episodeoverviewpage.verify_CM_PCP_Mbr_Opt_OutLetterGenerated(sUSERPROFILENAME),"Member Opts out letter generated to PCP");
		Assert.assertEquals(true,episodeoverviewpage.verify_CM_Mbr_Opt_OutLetterGenerated(sUSERPROFILENAME),"Member Opts out letter generated to Member");
		...
		logger.info("Successfully completed validating integration flow of #ZU-61_CCM_Member Opts out# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname);
		
		
		Reporter.log("Successfully completed validating integration flow of #ZU-61_CCM_Member Opts out# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname);
