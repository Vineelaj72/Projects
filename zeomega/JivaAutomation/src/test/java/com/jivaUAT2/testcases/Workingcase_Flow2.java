...
public class Workingcase_Flow2 extends TestBase {
	private static Logger logger = Logger.getLogger(Workingcase_Flow2.class);
...
//	@Parameters({"linenumber"})
	@BeforeMethod
		...
		/*MemberDemographicData =DemographicFileInput.mandatoryCheckPoints(MEMBERDEMOGRAPHICFILENAME,lineNumberInteger.parseInt(linenumber));   // demographic file
		...
		*/
		...
		memberSearchPage.enterMemberId("000000275");
