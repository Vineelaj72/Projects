...
public class Flow1_testngsuite extends TestBase {
	private static Logger logger = Logger.getLogger(Flow1_testngsuite.class);
	...
	public void verify_MemberData_fromfile_toScreen_ZU_60Integrationflow() throws InterruptedException {
		...
		logger.info("Successfully completed validating integration flow of #ZU-60_Unable to reach member# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname);
		
		Reporter.log("Successfully completed validating integration flow of #ZU-60_Unable to reach member# for the member holding the Member Id: "+MemberDemographicData.get(ALTERNATEID)+" and for the client: "+clientname);
