...
public class SanityTC_02 extends TestBase{
	WebDriver driver;

	@Test(description = "Add CM episode for active Jiva members without duplicate episodes in 24hrs assign program to self")
